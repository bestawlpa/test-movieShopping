  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        setIsLoading(false); // การโหลดเสร็จแล้ว
      }
    };
    fetchMovies();
  }, []);
                ...
                >
                  ...
                  <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between px-4 w-[250px] h-[50px] relative right-[20px] bottom-[46px]">
                      <div className=" flex">
                        <div className=" border-2 flex items-center justify-centerborder-2 w-[44px] h-[35px] text-white border-red-300 rounded-2xl">
                          {e.original_language}
                        </div>
                        <div className=" flex items-center justify-center border-2 w-[58px] h-[35px] text-white ml-2 border-red-300 rounded-2xl">
